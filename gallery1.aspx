...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <div class="fl_centre">
          <ul>
            <li><img src="../images/demo/glr9.jpg" width="280" height="150" alt="" /></li>
            <li class="last"><img src="../images/demo/glr10.jpg" width="280" height="150" alt="" /></li>
          </ul>
        </div>
    <div class="fl_centre">
          <ul>
            <li><img src="../images/demo/glr11.jpg" width="280" height="150" alt="" /></li>
            <li class="last"><img src="../images/demo/glr12.jpg" width="280" height="150" alt="" /></li>
          </ul>
        </div>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder5" Runat="Server">
    <div class="fl_centre">
          <ul>
            ...
            <li class="last"><img src="../images/demo/glr14.jpg" width="280" height="150" alt="" /></li>
          </ul>
        </div>
    <div class="fl_centre">
          <ul>
            <li><img src="../images/demo/glr15.jpg" width="280" height="150" alt="" /></li>
