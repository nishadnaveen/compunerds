...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
     <div class="fl_centre">
          <ul>
            <li><img src="../images/demo/glr1.jpg" width="280" height="150" alt="" /></li>
            <li class="last"><img src="../images/demo/glr2.jpg" width="280" height="150" alt="" /></li>
          </ul>
        </div>
    <div class="fl_centre">
          <ul>
            <li><img src="../images/demo/glr3.jpg" width="280" height="150" alt="" /></li>
            <li class="last"><img src="../images/demo/glr4.jpg" width="280" height="150" alt="" /></li>
          </ul>
        </div>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder5" Runat="Server">
     <div class="fl_centre">
          <ul>
            <li><img src="../images/demo/glr5.jpg" width="280" height="150" alt="" /></li>
            <li class="last"><img src="../images/demo/glr6.jpg" width="280" height="150" alt="" /></li>
          </ul>
        </div>
    <div class="fl_centre">
          <ul>
            <li><img src="../images/demo/glr7.jpg" width="280" height="150" alt="" /></li>
            <li class="last"><img src="../images/demo/glr8.jpg" width="280" height="150" alt="" /></li>
          </ul>
        </div>
</asp:Content>
